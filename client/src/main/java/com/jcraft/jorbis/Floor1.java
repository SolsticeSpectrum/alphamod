		...
		if(var1.opb.read(1) == 1) {
			...
			for(var8 = 2; var8 < var4.posts; ++var8) {
				...
				if(var13 != 0) {
					...
					var7[var4.loneighbor[var8 - 2]] &= Short.MAX_VALUE;
					var7[var4.hineighbor[var8 - 2]] &= Short.MAX_VALUE;
				} else {
					var7[var8] = var9 | -Short.MIN_VALUE;
				}
			}
	...
	int inverse2(Block var1, Object var2, Object var3, float[] var4) {
		...
		if(var3 != null) {
			...
			for(var12 = 1; var12 < var5.posts; ++var12) {
				...
				int var14 = var15[var13] & Short.MAX_VALUE;
